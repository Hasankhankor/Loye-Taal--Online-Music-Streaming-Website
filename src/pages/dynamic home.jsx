    ...
    <>
      <div className="flex flex-wrap midMd:flex-nowrap w-full gap-x-6 gap-y-6 py-4">
        <div className="w-full relative midMd:w-[65%] xl:w-3/5 h-[500px] sm:h-[400px]">
          <div className="relative w-full h-full bg-[#FFBD20] rounded-[20px] sm:rounded-[40px] z-[2] overflow-hidden">
            <img
            ...
            <div className="absolute py-10 px-[30px] sm:px-10 left-0 top-0 bottom-0 flex flex-col sm:justify-between">
              ...
              <h2 className="font-bold text-4xl mb-1 sm:mb-0">Pashto Folk</h2>
<p className="text-sm">
  دا زمونږه ژوندونه، سندرې او داستانونه <br />
  د غرونو په څپو کې، نغمې د زړه ویرونه <br />
  او د ژوند خوږې کیسې
</p>
